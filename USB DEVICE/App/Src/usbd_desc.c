...
#define USBD_PRODUCT_HS_STRING        "MSC HID in HS Mode"
#define USBD_PRODUCT_FS_STRING        "MSC HID in FS Mode"
#define USBD_CONFIGURATION_HS_STRING  "MSC HID Config"
#define USBD_INTERFACE_HS_STRING      "MSC HID Interface"
#define USBD_CONFIGURATION_FS_STRING  "MSC HID Config"
#define USBD_INTERFACE_FS_STRING      "MSC HID Interface"
...
uint8_t *USBD_Class_DeviceQualifierDescriptor(USBD_SpeedTypeDef speed, uint16_t *length);
